...
<div id="main_content">
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            <a href="page-profile.jsp"><img class="card-profile-img" src="assets/images/gallery/harshil.jpg" alt=""></a>
            <%AdminDao adminDao=new AdminDao();
                                                
							     List<AdminBean> listofAdmins = adminDao.listofAdmins();
							for (int i=0;i<listofAdmins.size();i++)
							{
								AdminBean adminBean=listofAdmins.get(i);
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="project-list.jsp"><i class="fa fa-list-ol"></i><span>Project list</span></a></li>
                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="Logout"><i class="dropdown-icon fe fe-log-out"></i> Sign out</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="card">
                                    ...
                                    List<ProjectBean>listofProject=projectDao.listofProjects();
                                        
							for (int i=0;i<listofProject.size();i++)
							{
								ProjectBean projectBean=listofProject.get(i);
							
						
                                    %>
                                    
                                        <span class="tag tag-blue mb-3"><%=projectBean.getpName()%></span>
                                              
							
                            
                                         <p><%=projectBean.getdEscription()%></p>
                                      
                                          
                                        <div class="row">
                                        
                                            <div class="col-5 py-1"><strong>Created:</strong></div>
                                            <div class="col-7 py-1"><%=projectBean.getpCredate() %>
                                            
                                            </div>
                                            <div class="col-5 py-1"><strong>Duration:</strong></div>
                                            <div class="col-7 py-1"><%=projectBean.getdUration() %>
                                           
                                            </div>
                                            <div class="col-5 py-1"><strong>Category:</strong></div>
                                            <div class="col-7 py-1"><strong><%=projectBean.getcAtigery()%></strong>

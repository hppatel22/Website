    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="app-contact.jsp"><i class="fa fa-address-book"></i><span>Contact</span></a></li>
                    ...
                    <div class="tab-pane fade show active" id="list" role="tabpanel">
                        <div class="row clearfix">
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="text-center width40">
                                                    <div class="avatar d-block">
                                                        <img class="avatar" src="assets/images/gallery/harshil1.jpg" alt="avatar">
                                                    </div>
                                                </td>
                                                <td>
							...
							<%=adminBean.geteName()%>
                                                ...
                                                <td class="hidden-xs">
                                                    <div class="text-muted"><%=adminBean.geteEmail() %></div>
                                                    <%} %>
                                                </td>
                                                <td class="hidden-sm">
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div><a href="AdminDao">Merri Diamond</a></div>

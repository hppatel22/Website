            ...
            <div class="card-body">
                <ul class="list-group list-unstyled">
                    <li class="list-group-item mb-2">
                        <p>Default Theme</p>
                        <a href="index-2.jsp"><img src="assets/images/themes/default.png" class="img-fluid" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>Night Mode Theme</p>
                        <a href="project-dark/index.jsp"><img src="assets/images/themes/dark.png" class="img-fluid" /></a>
                    </li>                    
                    <li class="list-group-item mb-2">
                        <p>RTL Version</p>
                        <a href="project-rtl/index.jsp"><img src="assets/images/themes/rtl.png" class="img-fluid" /></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            ...
            <%AdminDao adminDao4=new AdminDao();
							     ...
							     List<AdminBean> listofAdmins2 = adminDao4.listofAdmins();
							for (int i=0;i<listofAdmins2.size();i++)
							{
								AdminBean adminBean=listofAdmins2.get(i);
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li><a href="project-taskboard.jsp"><i class="fa fa-calendar-check-o"></i><span>Taskboard</span></a></li>
                ...
                <li class="active"><a href="project-clients.jsp"><i class="fa fa-user"></i><span>Clients</span></a></li>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body text-center ribbon">
                                        ...
                                        <img class="rounded-circle img-thumbnail w100" src="assets/images/gallery/harshil1.jpg" alt="">
                                      <%ClientDao clientDao=new ClientDao();
                                                
							     List<ClientBean> Listofclients= clientDao.listofClients();
							for (int i=0;i<Listofclients.size();i++)
							{
								ClientBean clientBean=Listofclients.get(i);
								
							
							%>
                                        <h6 class="mt-3 mb-0"><%=clientBean.getcFirstname()%></h6>
                                       
                                        <span><%=clientBean.getcEmail() %></span>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <form class="card-body" action="Client">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Date of Birth" name="txtdob">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-12">
                                                <label>Gender</label>
                                                
                                                <select class="form-control show-tick" name="txtgender">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                             ...
                                             <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    <label>Project</label>
                                                    <select class="form-control show-tick" name="pname">
                                                    <option value="0">Select Project</option>
                                                    <%ProjectDao projectDao=new ProjectDao();
                                                    List<ProjectBean>listOfProjects=projectDao.listofProjects();
                                                    for(int i=0;i<listOfProjects.size();i++)
                                                    {
                                                    ProjectBean projectBean=listOfProjects.get(i);
                                                   
                                                     %>
                                                     <option value="<%=projectBean.getpId()%>"><%=projectBean.getpName() %></option>
                                                     <% } %>
                                                    </select>

    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                ...
                <div class="dropdown">
                    <a href="javascript:void(0)" class="nav-link user_btn"><img class="avatar" src="assets/images/gallery/harshil1.jpg" alt="" data-toggle="tooltip" data-placement="right" title="User Menu"/></a>
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            <a href="page-profile.jsp"><img class="card-profile-img" src="assets/images/gallery/harshil1.jpg" alt=""></a>
              ...
              %>
              <h6 class="mb-0"><%out.print(name); %></h6>
             <%HttpSession session1=request.getSession();
              String em=(String)session1.getAttribute("Email");
              String nm=(String)session1.getAttribute("Name");
              out.print(em);
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="index-2.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>                        
                <li><a href="login.jsp"><i class="fa fa-list-ol"></i><span>Project list</span></a></li>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <%int count=adminDao.getCount(); %>
                                ...
                                <h5 class="number mb-0 font-32 counter"><%=count%></h5>

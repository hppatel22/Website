...
<div id="main_content">
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            <a href="page-profile.jsp"><img class="card-profile-img" src="assets/images/sm/avatar1.jpg" alt=""></a>
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="active"><a href="project-todo.jsp"><i class="fa fa-check-square-o"></i><span>Todo List</span></a></li>
